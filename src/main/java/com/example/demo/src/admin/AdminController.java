...
import static com.example.demo.common.code.status.SuccessStatus.ADMIN_OK;
...
public class AdminController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "회원 검색 성공"),
    ...
    public BaseResponse<Page<GetCondUserRes>> getAdminUsers(
        ...
        return BaseResponse.of(ADMIN_OK, adminService.getAdminUsers(userSearchCond, page, size));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "회원 단일 조회 성공"),
    ...
    public BaseResponse<User> getUser(@PathVariable("userId") Long userId) {
        return BaseResponse.of(ADMIN_OK, adminService.getUser(userId));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "회원 정지 성공"),
            @ApiResponse(responseCode = "USER4004", description = "일치하는 유저가 없습니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    })
    @Parameters({
            @Parameter(name = "userId", description = "userId 번호"),
    ...
    public BaseResponse<String> patchUser(@PathVariable("userId") Long userId, @RequestParam("state") State state) {
        return BaseResponse.of(ADMIN_OK, adminService.patchUser(userId, state));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "게시글 검색 성공"),
            @ApiResponse(responseCode = "PAGE4000", description = "페이지는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "PAGE4002", description = "사이즈는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public BaseResponse<Page<GetCondBoardRes>> getAdminBoards(
            ...
            @RequestParam("page") Integer page, @RequestParam("size") Integer size) {
        return BaseResponse.of(ADMIN_OK, adminService.getAdminBoards(boardSearchCond, page, size));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "게시글 단일 조회 성공"),
    ...
    public BaseResponse<GetBoardRes> getBoard(@PathVariable("boardId") Long boardId) {
        return BaseResponse.of(ADMIN_OK, adminService.getBoard(boardId));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "게시글 삭제 성공"),
            @ApiResponse(responseCode = "BOARD4000", description = "존재하지 않는 게시글입니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public BaseResponse<String> patchBoard(@PathVariable("boardId") Long boardId) {
        return BaseResponse.of(ADMIN_OK, adminService.patchBoard(boardId));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "신고 전체 조회 성공"),
            @ApiResponse(responseCode = "PAGE4000", description = "페이지는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "PAGE4002", description = "사이즈는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public BaseResponse<Page<GetReportRes>> getReports(@RequestParam("page") Integer page, @RequestParam("size") Integer size) {
        return BaseResponse.of(ADMIN_OK, adminService.getReports(page, size));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "신고 삭제 성공"),
            @ApiResponse(responseCode = "BOARD4000", description = "존재하지 않는 게시글입니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public BaseResponse<String> patchReport(@PathVariable("reportId") Long reportId) {
        return BaseResponse.of(ADMIN_OK, adminService.patchReport(reportId));
    }
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "ADMIN200",description = "로그 전체 조회 성공"),
            @ApiResponse(responseCode = "PAGE4000", description = "페이지는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "PAGE4002", description = "사이즈는 0 이상이어야 합니다.",content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public BaseResponse<Page<?>> getLogs(@RequestParam("domainName") DomainName domainName, @RequestParam("page") Integer page, @RequestParam("size") Integer size) {
        return BaseResponse.of(ADMIN_OK, adminService.getLogs(domainName, page, size));
    }
